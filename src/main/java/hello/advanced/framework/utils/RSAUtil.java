...
public class RSAUtil {
     ...
     * 1024비트 RSA 키쌍을 생성
     */
    public static KeyPair genRSAKeyPairFor1024() throws NoSuchAlgorithmException {
     ...
     * 2048비트 RSA 키쌍을 생성
     */
    public static KeyPair genRSAKeyPairFor2048() throws NoSuchAlgorithmException {
        KeyPairGenerator gen = KeyPairGenerator.getInstance("RSA");
        gen.initialize(2048);
